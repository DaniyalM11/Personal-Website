  ...
  return (
    <>
      ...
      >
        ...
        I continuously strive to expand my knowledge across various machine learning, engineering and data analytics disciplines. Outside of work, I enjoy working on projects in diverse technology domains. My career goal is to develop a solid foundation in multiple machine learning, engineering and analytics disciplines to lead innovative, interdisciplinary machine learning, engineering and analytics projects throughout my career. I hold a BBA degree in Actuarial Science from Temple University and an MSc in Machine Learning from Stevens Institute of Technology.
      </motion.p>
