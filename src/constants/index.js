  ...
  const experiences = [
    ...
    },    
    {
      ...
      points: [
        ...
        "Assisted actuaries with portfolio specific data analysis, data management, data modeling and data engineering work. Work involved requirement gathering, designing and programming ETL workflows, designing specific data models for actuarial team to query and performing data analysis on portfolio data.",
    ...
    },
    {
      ...
      points: [
        ...
        "Led, performed and supervised the AIG international quarter close process. Process involved booking IBNR reserves on a US GAAP and Local STAT basis for all countries and every line of business AIG operates in, where held totaled numerous billions in IBNR reserves. Process also involved continuous communications with regional actuaries, senior management, regional accountants and profit centers heads. Maintained SOX complaince documentation for the process.",
        "Enhanced and maintained data platform which was built using a star schema based dimensional data model built in MS Access and excel templates and VBA based macros. The system was used to maintain machine data for IBNR reserve booking process during quarter close and was also used to balance to ledger postings and reserving totals that were populated in the reserving templates. Enhanced and maintained Excel VBA based data pipelines to move data from data model into quarterly IBNR booking analysis templates, balancing templates and reserve study templates. Maintained quarterly SOX compliance documentation for system. In later years, the model began to be moved onto Oracle from MS Access.",
      ],
    },
